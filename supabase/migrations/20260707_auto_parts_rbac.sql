...
GRANT EXECUTE ON FUNCTION public.auto_parts_create_product TO anon, authenticated;
GRANT EXECUTE ON FUNCTION public.auto_parts_list_categories TO anon, authenticated;
GRANT EXECUTE ON FUNCTION public.auto_parts_list_suppliers TO anon, authenticated;
GRANT EXECUTE ON FUNCTION public.auto_parts_list_clients TO anon, authenticated;
GRANT EXECUTE ON FUNCTION public.auto_parts_dashboard_stats TO anon, authenticated;
GRANT EXECUTE ON FUNCTION public.auto_parts_create_sale TO anon, authenticated;
GRANT EXECUTE ON FUNCTION public.auto_parts_list_staff TO anon, authenticated;
GRANT EXECUTE ON FUNCTION public.auto_parts_list_sales TO anon, authenticated;
GRANT EXECUTE ON FUNCTION public.auto_parts_list_stock_movements TO anon, authenticated;
