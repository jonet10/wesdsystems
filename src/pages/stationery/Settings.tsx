...
export default function StationerySettings() {
  ...
  return (
    <DashboardLayout
      role="salon_admin"
      title="Paramètres Papeterie"
      subtitle="Configurez votre établissement pour le module papeterie"
    >
      <StaggerContainer>
              ...
              <StaggerItem>
                <div className="bg-card rounded-xl border border-border p-6 shadow-card space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold font-display">Fiche de la Papeterie</h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label htmlFor="company-name">Nom de la Papeterie *</Label>
