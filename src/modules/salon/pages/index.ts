...
export { default as SalonExpensesPage } from "@/pages/salon/Expenses";
export { default as SalonInventoryPage } from "@/pages/salon/Inventory";
export { default as SalonPOSPage } from "@/pages/salon/POS";
export { default as SalonProductsPage } from "@/pages/salon/Products";
export { default as SalonPromotionsPage } from "@/pages/salon/Promotions";
export { default as SalonReportsPage } from "@/pages/salon/Reports";
