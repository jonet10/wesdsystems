...
('XCD', 'EC$', 'Dollar des Caraïbes orientales', 'en-AG', true, false),
('JMD', 'J$', 'Dollar Jamaïcain', 'en-JM', true, false),
('TTD', 'TT$', 'Dollar de Trinité-et-Tobago', 'en-TT', true, false),
('BBD', 'Bds$', 'Dollar barbadien', 'en-BB', true, false),
('BSD', 'B$', 'Dollar bahaméen', 'en-BS', true, false),
('XOF', 'CFA', 'Franc CFA BCEAO', 'fr-SN', true, false),
('XAF', 'FCFA', 'Franc CFA BEAC', 'fr-CM', true, false),
('NGN', '₦', 'Naira nigérian', 'en-NG', true, false),
('GHS', 'GH₵', 'Cedi ghanéen', 'en-GH', true, false),
('KES', 'KSh', 'Shilling kényan', 'en-KE', true, false),
('MAD', 'DH', 'Dirham marocain', 'fr-MA', true, false)
...
('AG', 'Antigua-et-Barbuda', 'XCD', 'America/Antigua', 'en-AG', true),
('DM', 'Dominique', 'XCD', 'America/Dominica', 'en-DM', true),
('KN', 'Saint-Christophe-et-Niévès', 'XCD', 'America/St_Kitts', 'en-KN', true),
('LC', 'Sainte-Lucie', 'XCD', 'America/St_Lucia', 'en-LC', true),
('VC', 'Saint-Vincent-et-les-Grenadines', 'XCD', 'America/St_Vincent', 'en-VC', true),
('GD', 'Grenade', 'XCD', 'America/Grenada', 'en-GD', true),
('BB', 'Barbade', 'BBD', 'America/Barbados', 'en-BB', true),
('BS', 'Bahamas', 'BSD', 'America/Nassau', 'en-BS', true),
('JM', 'Jamaïque', 'JMD', 'America/Jamaica', 'en-JM', true),
('TT', 'Trinité-et-Tobago', 'TTD', 'America/Port_of_Spain', 'en-TT', true),
('MA', 'Maroc', 'MAD', 'Africa/Casablanca', 'fr-MA', true),
('SN', 'Sénégal', 'XOF', 'Africa/Dakar', 'fr-SN', true),
('CI', 'Côte d’Ivoire', 'XOF', 'Africa/Abidjan', 'fr-CI', true),
('BJ', 'Bénin', 'XOF', 'Africa/Porto-Novo', 'fr-BJ', true),
('TG', 'Togo', 'XOF', 'Africa/Lome', 'fr-TG', true),
('BF', 'Burkina Faso', 'XOF', 'Africa/Ouagadougou', 'fr-BF', true),
('ML', 'Mali', 'XOF', 'Africa/Bamako', 'fr-ML', true),
('NE', 'Niger', 'XOF', 'Africa/Niamey', 'fr-NE', true),
('CM', 'Cameroun', 'XAF', 'Africa/Douala', 'fr-CM', true),
('GA', 'Gabon', 'XAF', 'Africa/Libreville', 'fr-GA', true),
('TD', 'Tchad', 'XAF', 'Africa/Ndjamena', 'fr-TD', true),
('CF', 'République centrafricaine', 'XAF', 'Africa/Bangui', 'fr-CF', true),
('CG', 'Congo-Brazzaville', 'XAF', 'Africa/Brazzaville', 'fr-CG', true),
('GQ', 'Guinée équatoriale', 'XAF', 'Africa/Malabo', 'es-GQ', true),
('NG', 'Nigeria', 'NGN', 'Africa/Lagos', 'en-NG', true),
('GH', 'Ghana', 'GHS', 'Africa/Accra', 'en-GH', true),
('KE', 'Kenya', 'KES', 'Africa/Nairobi', 'en-KE', true)
